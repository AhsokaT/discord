        ...
        const payload = {
            ...
            components: [
                new discord_js_1.ActionRowBuilder()
                    ...
                    .setValue('TIGER')
                    .setEmoji(housePicker_1.HouseEmoji.TIGER)
                    ...
                    .setValue('OWL')
                    .setEmoji(housePicker_1.HouseEmoji.OWL)
                    ...
                    .setValue('RAVEN')
                    .setEmoji(housePicker_1.HouseEmoji.RAVEN)
                    ...
                    .setValue('TURTLE')
                    .setEmoji(housePicker_1.HouseEmoji.TURTLE)
                    ...
                    .setValue('PANDA')
                    .setEmoji(housePicker_1.HouseEmoji.PANDA)
